...
class GithubDrawer(TracksDrawer):
    ...
    def draw(self, dr: svgwrite.Drawing, size: XY, offset: XY):
        ...
        year_style = f"font-size:{year_size}px; font-family:'Ysabeau Office', 'LXGW Bright Code Light';"
        year_length_style = f"font-size:{110 * 3.0 / 80.0}px; font-family:'Ysabeau Office', 'LXGW Bright Code Light';"
        month_names_style = "font-size:2.5px; font-family:'Ysabeau Office', 'LXGW Bright Code Light'"
